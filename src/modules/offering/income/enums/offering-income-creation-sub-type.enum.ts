...
> = {
  ...
  [OfferingIncomeCreationSubType.GeneralEvangelism]: 'Evangelismo General',
  [OfferingIncomeCreationSubType.ZonalEvangelism]: 'Evangelismo Zonal',
  [OfferingIncomeCreationSubType.SundaySchool]: 'Escuela Dominical',
  [OfferingIncomeCreationSubType.YouthService]: 'Culto Jóvenes',
  [OfferingIncomeCreationSubType.UnitedService]: 'Culto Unido General',
  [OfferingIncomeCreationSubType.ZonalUnitedService]: 'Culto Unido Zonal',
